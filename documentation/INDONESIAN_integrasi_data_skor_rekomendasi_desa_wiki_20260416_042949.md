...
- [Penyiapan Server (Ubuntu / Debian)](#penyiapan-server-ubuntu--debian)
    - [Perbarui Sistem](#1-perbarui-sistem)
    - [Instal Git](#2-instal-git)
    - [Instal Docker dan Docker Compose](#3-instal-docker-dan-docker-compose)
    - [Instal Python 3.11 dan Lingkungan Virtual](#4-instal-python-311-dan-lingkungan-virtual)
    - [Instal Node.js, npm, dan npx](#5-instal-nodejs-npm-dan-npx)
    - [Instal OpenSSL](#6-instal-openssl)
    - [Kompilasi Tailwind CSS](#7-kompilasi-tailwind-css)
    - [Hasilkan APP_SECRET_KEY dan Buat .env](#8-hasilkan-app_secret_key-dan-buat-env)
    - [Tambahkan Pengguna Pertama](#9-tambah-pengguna-pertama)
    - [Mulai Tumpukan Aplikasi](#10-mulai-tumpukan-aplikasi)

- [Manajemen Server dengan Tmux](#server-management-with-tmux)
    - [Perintah Manajemen Sesi](#session-management-commands)
    - [Cheatsheet Esensial](#essential-keybindings)
    - [Pemulihan Inisialisasi Layanan](#service-initialization-fallback)

- [Gambaran Umum Cloudflare Tunnel](#cloudflare-tunnel-overview)
    - [Prasyarat](#prerequisites)
    - [Metode A: Tunnel Gratis Sementara (Tanpa Domain)](#method-a-temporary-free-tunnel-no-domain)
    - [Metode B: Tunnel Permanen (Domain Kustom)](#method-b-permanent-tunnel-custom-domain)
        - [Autentikasi](#authentication)
        - [Pembuatan Tunnel](#tunnel-creation)
        - [Konfigurasi](#configuration)
        - [Eksekusi](#execution)

- [Gambaran Umum Mekanisme Pencadangan (Backup)](#backup-mechanism-overview)
    - [Lokasi Penyimpanan](#storage-locations)
    - [Prosedur Pemulihan Langkah demi Langkah](#step-by-step-restore-procedure)
        - [Hentikan Layanan Backend](#stop-the-backend-service)
        - [Temukan Cadangan (Backup)](#locate-the-backup)
        - [Ganti Berkas Basis Data](#replace-the-database-files)
        - [Mulai Ulang Layanan](#restart-the-service)
        - [Verifikasi Log](#verify-the-logs)

- [Pengantar Proyek](#pengantar-proyek)
    - [Tinjauan Arsitektur Sistem](#tinjauan-arsitektur-sistem)
        - [Layanan Backend](#layanan-backend)
        - [Antarmuka Frontend](#antarmuka-frontend)
        - [Manajemen Konfigurasi](#manajemen-konfigurasi)
    - [Komponen Inti dan Fungsionalitas](#komponen-inti-dan-fungsionalitas)
        - [Integrasi dan Pemrosesan Data](#integrasi-dan-pemrosesan-data)
            - [Skema dan Manajemen Basis Data](#skema-dan-manajemen-basis-data)
        - [Pembuatan Laporan Excel](#pembuatan-laporan-excel)
            - [Detail Dasbor Rekomendasi](#detail-dasbor-rekomendasi)
            - [Detail Dasbor IKU](#detail-dasbor-iku)
        - [Berkas dan Struktur Konfigurasi](#berkas-dan-struktur-konfigurasi)
        - [Konfigurasi Penataan Gaya dan Frontend](#konfigurasi-penataan-gaya-dan-frontend)
    - [Penyebaran dan Pengembangan](#penyebaran-dan-pengembangan)
        - [Penyebaran Docker](#penyebaran-docker)
        - [Pengujian](#pengujian)
    - [Elemen Antarmuka Pengguna](#elemen-antarmuka-pengguna)
        - [Halaman Masuk](#halaman-masuk)
        - [Dasbor Admin](#dasbor-admin)
        - [Dasbor Pengguna](#dasbor-pengguna)

- [Persyaratan Sistem](#persyaratan-sistem)
    - [Dependensi Perangkat Lunak](#dependensi-perangkat-lunak)
        - [Versi Python](#versi-python)
        - [Paket Python Inti](#paket-python-inti)
    - [Lingkungan Runtime](#lingkungan-runtime)
        - [Sistem Operasi](#sistem-operasi)
        - [Rekomendasi Perangkat Keras](#rekomendasi-perangkat-keras)
    - [Konfigurasi](#konfigurasi)
        - [Direktori Berkas Konfigurasi](#direktori-berkas-konfigurasi)
        - [Berkas Konfigurasi Kunci](#berkas-konfigurasi-kunci)
        - [Variabel Lingkungan](#variabel-lingkungan)
    - [Instalasi dan Penyiapan](#instalasi-dan-penyiapan)
        - [Instalasi dan Menjalankan Docker](#instalasi-dan-menjalankan-docker)
    - [Menjalankan Sistem](#menjalankan-sistem)
        - [Menjalankan dengan Docker Compose](#menjalankan-dengan-docker-compose)
    - [Penyiapan Pengembangan Frontend](#penyiapan-pengembangan-frontend)
        - [Kompilasi Tailwind CSS](#konfigurasi-tailwind-css-1)
    - [Pengujian](#pengujian-1)
        - [Menjalankan Pengujian](#menjalankan-pengujian)
    - [Tinjauan Arsitektur Sistem](#tinjauan-arsitektur-sistem-1)
        - [API Backend (desa_db/server.py)](#api-backend-desa_dbserverpy)
        - [Pemrosesan Data dan Middleware (desa_db/middleware.py)](#pemrosesan-data-dan-middleware-desa_dbmiddlewarepy)
        - [Frontend (front_end/)](#frontend-front_end)
        - [Contoh Alur Kerja: Pembuatan Dasbor](#contoh-alur-kerja-pembuatan-dasbor)
        - [Contoh Alur Kerja: Otentikasi Pengguna](#contoh-alur-kerja-otentikasi-pengguna)
    - [Penyiapan Pengembangan dan Pengujian](#penyiapan-pengembangan-dan-pengujian)
        - [Penyiapan Data Tiruan dan Konfigurasi](#penyiapan-data-tiruan-dan-konfigurasi)
        - [Eksekusi Pengujian](#eksekusi-pengujian)
    - [Penataan Gaya Frontend](#penataan-gaya-frontend)
        - [Contoh Penataan Gaya Halaman Masuk](#contoh-penataan-gaya-halaman-masuk)

- [Tinjauan Arsitektur](#tinjauan-arsitektur)
    - [Penyebaran dan Orkestrasi Sistem](#penyebaran-dan-orkestrasi-sistem)
        - [Layanan Docker Compose](#layanan-docker-compose)
        - [Interkoneksi Layanan](#interkoneksi-layanan)
    - [Layanan Backend (desa_db/server.py)](#layanan-backend-desa_dbserverpy)
        - [Fungsionalitas Inti](#fungsionalitas-inti)
        - [Komponen dan Modul Kunci](#komponen-dan-modul-kunci)
        - [Tinjauan Endpoint API](#tinjauan-endpoint-api)
    - [Layanan Frontend (front_end/router.py)](#layanan-frontend-front_endrouterpy)
        - [Tanggung Jawab Kunci](#tanggung-jawab-kunci)
        - [Perutean dan Tampilan](#perutean-dan-tampilan)
        - [Manajemen *Reverse Proxy* dan Aset Statis (Nginx)](#manajemen-reverse-proxy-dan-aset-statis-nginx)
        - [Konfigurasi Nginx](#konfigurasi-nginx)
    - [Manajemen Konfigurasi](#manajemen-konfigurasi-1)
        - [Berkas Konfigurasi](#berkas-konfigurasi)
    - [Alur dan Pemrosesan Data](#alur-dan-pemrosesan-data)
        - [Pemuatan dan Persiapan Data](#pemuatan-dan-persiapan-data)
        - [Perhitungan Skor dan Rekomendasi](#perhitungan-skor-dan-rekomendasi)
        - [Pembuatan Laporan](#pembuatan-laporan)
    - [Penataan Gaya dan Tema Frontend](#penataan-gaya-dan-tema-frontend)
        - [Konfigurasi Tailwind CSS](#konfigurasi-tailwind-css-2)
        - [Kelas Utilitas](#kelas-utilitas)
    - [Kesimpulan](#kesimpulan)

- [Diagram Alur Data](#diagram-alur-data)
    - [Komponen Inti dan Alur Data](#komponen-inti-dan-alur-data)
        - [Endpoint API Backend](#endpoint-api-backend)
            - [Alur Otentikasi](#alur-otentikasi)
            - [Unggah dan Pemrosesan Data](#unggah-dan-pemrosesan-data)
        - [Logika Middleware](#logika-middleware)
            - [Inisialisasi dan Manajemen Basis Data](#inisialisasi-dan-manajemen-basis-data)
            - [Pembuatan Laporan (Excel)](#pembuatan-laporan-excel-1)
            - [Perenderan Dasbor (HTML)](#perenderan-dasbor-html)
        - [Komponen Frontend](#komponen-frontend)
            - [Perutean](#perutean)
    - [Konfigurasi dan Model Data](#konfigurasi-dan-model-data)
        - [Berkas Konfigurasi](#berkas-konfigurasi-1)
        - [Skema Basis Data](#skema-basis-data)
    - [Penyiapan Pengujian dan Pengembangan](#penyiapan-pengujian-dan-pengembangan)
        - [Penyebaran Docker](#penyebaran-docker-1)
        - [Pengujian Unit dan Integrasi](#pengujian-unit-dan-integrasi)
    - [Ringkasan](#ringkasan)

- [Hubungan Komponen](#hubungan-komponen)
    - [Layanan Backend (desa_db)](#layanan-backend-desa_db)
        - [Fungsionalitas dan Modul Inti](#fungsionalitas-dan-modul-inti)
        - [Alur Otentikasi](#alur-otentikasi-1)
        - [Pemrosesan Data dan Pelaporan](#pemrosesan-data-dan-pelaporan)
    - [Layanan Frontend (front_end)](#layanan-frontend-front_end)
        - [Berkas dan Teknologi Kunci](#berkas-dan-teknologi-kunci)
        - [Penataan Gaya dengan Tailwind CSS](#penataan-gaya-dengan-tailwind-css)
    - [Orkestrasi Docker (docker-compose.yml)](#orkestrasi-docker-docker-composeyml)
        - [Layanan yang Didefinisikan](#layanan-yang-didefinisikan)
    - [Manajemen Konfigurasi](#manajemen-konfigurasi-2)
        - [Berkas Konfigurasi Kunci](#berkas-konfigurasi-kunci-1)
        - [Alur dan Interaksi Data](#alur-dan-interaksi-data)

- [Unggah dan Pemrosesan Data](#unggah-dan-pemrosesan-data-1)
    - [Endpoint Unggah Data](#endpoint-unggah-data)
        - [Inisialisasi Unggahan yang Dapat Dilanjutkan (/upload/init/{year})](#inisialisasi-unggahan-yang-dapat-dilanjutkan-uploadinityear)
        - [Potongan Unggahan (/upload/chunk/{year})](#potongan-unggahan-uploadchunkyear)
        - [Finalisasi Unggahan (/upload/finalize/{year})](#finalisasi-unggahan-uploadfinalizeyear)
    - [Antarmuka Unggahan Frontend](#antarmuka-unggahan-frontend)
        - [Halaman Admin (/admin)](#halaman-admin-admin)
    - [Hashing dan Integritas Berkas](#hashing-dan-integritas-berkas)
        - [SparkMD5](#sparkmd5)
    - [Alur Pemrosesan Data](#alur-pemrosesan-data)
    - [Model API untuk Unggahan](#model-api-untuk-unggahan)
    - [Kasus Uji](#kasus-uji)
    - [Konfigurasi dan Konstanta](#konfigurasi-dan-konstanta)
    - [Perlindungan Server dan Perutean](#perlindungan-server-dan-perutean)
    - [Logika Pemrosesan Data (Tersirat)](#logika-pemrosesan-data-tersirat)

- [Dasbor dan Pelaporan](#dasbor-dan-pelaporan)
    - [Komponen Pelaporan Inti](#komponen-pelaporan-inti)
        - [Berkas Konfigurasi](#berkas-konfigurasi-2)
        - [Pembuatan Buku Kerja Excel](#pembuatan-buku-kerja-excel)
        - [Penataan Gaya dan Pemformatan](#penataan-gaya-dan-pemformatan)
    - [Lembar 1: Data Grid](#lembar-1-data-grid)
        - [Pemuatan dan Transformasi Data](#pemuatan-dan-transformasi-data)
        - [Penulisan Header dan Data](#penulisan-header-dan-data)
        - [Pemformatan](#pemformatan)
    - [Lembar 2: Dasbor Rekomendasi](#lembar-2-dasbor-rekomendasi)
        - [Pemuatan Data dan Konfigurasi](#pemuatan-data-dan-konfigurasi)
        - [Pemrosesan dan Perhitungan Data](#pemrosesan-dan-perhitungan-data)
        - [Pemformatan Header dan Kolom](#pemformatan-header-dan-kolom)
        - [Penggabungan dan Penataan Gaya Baris](#penggabungan-dan-penataan-gaya-baris)
    - [Lembar 3: Dasbor IKU](#lembar-3-dasbor-iku)
        - [Pemuatan dan Pemetaan Data](#pemuatan-dan-pemetaan-data)
        - [Logika Pengelompokan dan Agregasi](#logika-pengelompokan-dan-agregasi)
        - [Perenderan dan Penataan Gaya Header](#perenderan-dan-penataan-gaya-header)
        - [Penyajian Data](#penyajian-data)
    - [Antarmuka Pengguna](#antarmuka-pengguna)
        - [Dasbor Admin (admin.html)](#dasbor-admin-adminhtml)
        - [Dasbor Pengguna (user.html)](#dasbor-pengguna-userhtml)
    - [Endpoint API Backend](#endpoint-api-backend-1)
        - [Endpoint /dashboard](#endpoint-dashboard)
        - [Endpoint /dashboard_iku](#endpoint-dashboard_iku)
        - [Endpoint /download_excel](#endpoint-download_excel)
    - [Alur Data dan Arsitektur](#alur-data-dan-arsitektur)
        - [Contoh Alur Permintaan (Unduh Excel)](#contoh-alur-permintaan-unduh-excel)
        - [Alur Perenderan HTML (Dasbor IKU)](#alur-perenderan-html-dasbor-iku)
    - [Pengujian](#pengujian-2)
        - [Pengujian Unit untuk Server dan Pelaporan](#pengujian-unit-untuk-server-dan-pelaporan)

- [Otentikasi dan Otorisasi Pengguna](#otentikasi-dan-otorisasi-pengguna)
    - [Alur Otentikasi](#alur-otentikasi-2)
        - [Proses Masuk](#proses-masuk)
        - [Pembuatan JWT dan Manajemen Kuki](#pembuatan-jwt-dan-manajemen-kuki)
        - [Proses Keluar](#proses-keluar)
    - [Otorisasi dan Kontrol Akses Berbasis Peran](#otorisasi-dan-kontrol-akses-berbasis-peran)
        - [Peran Pengguna](#peran-pengguna)
        - [Penegakan Peran](#penegakan-peran)
    - [Manajemen Pengguna](#manajemen-pengguna)
        - [Menambahkan Pengguna](#menambahkan-pengguna)
        - [Hashing Kata Sandi](#hashing-kata-sandi)
    - [Penyimpanan Data untuk Otentikasi](#penyimpanan-data-untuk-otentikasi)
    - [Komponen dan Berkas Kunci](#komponen-dan-berkas-kunci)
    - [Tinjauan Arsitektur](#tinjauan-arsitektur-1)
        - [Diagram Alur Otentikasi](#diagram-alur-otentikasi)
        - [Diagram Pemeriksaan Otorisasi](#diagram-pemeriksaan-otorisasi)

- [Berkas Konfigurasi](#berkas-konfigurasi-3)
    - [Direktori Berkas Konfigurasi](#direktori-berkas-konfigurasi-1)
    - [Berkas Konfigurasi Kunci](#berkas-konfigurasi-kunci-2)
    ...
    - [Alur dan Pemrosesan Data](#alur-dan-pemrosesan-data-1)
        - [Alur Data Dasbor Rekomendasi](#alur-data-dasbor-rekomendasi)
        - [Alur Data Dasbor IKU](#alur-data-dasbor-iku)
    - [Manajemen Konfigurasi](#manajemen-konfigurasi-3)
        - [Menambahkan Pengguna](#menambahkan-pengguna-1)
        - [Variabel Lingkungan](#variabel-lingkungan-1)
        - [Konfigurasi Tailwind CSS](#konfigurasi-tailwind-css-3)

- [Struktur Basis Data](#struktur-basis-data)

- [Endpoint API Backend](#endpoint-api-backend-2)
    - [Endpoint Otentikasi](#endpoint-otentikasi)
        - [Endpoint Masuk](#endpoint-masuk)
        - [Endpoint Keluar](#endpoint-keluar)
        - [Middleware Otentikasi](#middleware-otentikasi)
    - [Endpoint Data dan Konfigurasi](#endpoint-data-dan-konfigurasi)
        - [Endpoint Struktur Tabel](#endpoint-struktur-tabel)
        - [Endpoint Pratinjau dan Pemrosesan Excel](#endpoint-pratinjau-dan-pemrosesan-excel)
    - [Endpoint Dasbor dan Pelaporan](#endpoint-dasbor-dan-pelaporan)
        - [Endpoint Pembuatan Buku Kerja Excel](#endpoint-pembuatan-buku-kerja-excel)
        - [Endpoint Perenderan Dasbor](#endpoint-perenderan-dasbor)
    - [Orkestrasi dan Konfigurasi Sistem](#orkestrasi-dan-konfigurasi-sistem)
        - [docker-compose.yml](#docker-composeyml)
    - [Pengujian](#pengujian-3)
    - [Ringkasan Endpoint API](#ringkasan-endpoint-api)

- [Modul Otentikasi](#modul-otentikasi)
    - [Manajemen Pengguna](#manajemen-pengguna-1)
        - [Menambahkan Pengguna Baru](#menambahkan-pengguna-baru)
            - [Penggunaan](#penggunaan)
        - [Penyimpanan Data Pengguna](#penyimpanan-data-pengguna)
    - [Alur Otentikasi](#alur-otentikasi-3)
        - [Proses Masuk](#proses-masuk-1)
            - [Endpoint Masuk (/api/login)](#endpoint-masuk-apilogin)
        - [Proses Keluar](#proses-keluar-1)
        - [Rute Terlindungi](#rute-terlindungi)
    - [Otorisasi](#otorisasi)
        - [Kontrol Akses Berbasis Peran](#kontrol-akses-berbasis-peran)
    - [Pertimbangan Keamanan](#pertimbangan-keamanan)
        - [Hashing Kata Sandi](#hashing-kata-sandi-1)
        - [Keamanan JWT](#keamanan-jwt)
    - [Konfigurasi](#konfigurasi-1)
        - [Variabel Lingkungan APP_SECRET_KEY](#variabel-lingkungan-app_secret_key)
    - [Pengujian](#pengujian-4)
    - [Komponen Kunci](#komponen-kunci)

- [Tinjauan Frontend](#tinjauan-frontend)
    - [Arsitektur dan Penyiapan](#arsitektur-dan-penyiapan)
        - [Komponen dan Penyiapan Inti](#komponen-dan-penyiapan-inti)
        - [Dependensi dan Penataan Gaya](#dependensi-dan-penataan-gaya)
    - [Perutean dan Antarmuka Pengguna](#perutean-dan-antarmuka-pengguna)
        - [Otentikasi dan Pengalihan](#otentikasi-dan-pengalihan)
        - [Integrasi API](#integrasi-api)
    - [Alur Kerja Pengembangan Frontend](#alur-kerja-pengembangan-frontend)
        - [Server Pengembangan](#server-pengembangan)
        - [Penataan Gaya dengan Tailwind CSS](#penataan-gaya-dengan-tailwind-css-1)
    - [Alur dan Interaksi Data](#alur-dan-interaksi-data-1)
        - [Alur Otentikasi Pengguna](#alur-otentikasi-pengguna)
        - [Alur Penyajian Data](#alur-penyajian-data)
    - [Konfigurasi](#konfigurasi-2)
        - [Variabel Lingkungan](#variabel-lingkungan-2)
        - [Konfigurasi Frontend di router.py](#konfigurasi-frontend-di-routerpy)
    - [Penataan Gaya dan Elemen UI](#penataan-gaya-dan-elemen-ui)
        - [Konfigurasi Tailwind CSS](#konfigurasi-tailwind-css-4)
        - [Kelas Utilitas CSS](#kelas-utilitas-css)

- [Halaman Masuk](#halaman-masuk-1)
    - [Antarmuka Pengguna (Frontend)](#antarmuka-pengguna-frontend)
        - [Elemen UI Kunci:](#elemen-ui-kunci)
    - [Alur Otentikasi (Interaksi Frontend & Backend)](#alur-otentikasi-interaksi-frontend--backend)
        - [Perutean Frontend (front_end/router.py)](#perutean-frontend-front_endrouterpy-1)
        - [API Backend (desa_db/server.py)](#api-backend-desa_dbserverpy-1)
    - [Logika Otentikasi (desa_db/auth.py)](#logika-otentikasi-desa_dbauthpy)
        - [Fungsi Kunci:](#fungsi-kunci)
    - [Model Data dan Skema](#model-data-dan-skema)
        - [Permintaan Masuk (desa_db/server.py)](#permintaan-masuk-desa_dbserverpy)
        - [Struktur Data Pengguna (dari auth_users.json)](#struktur-data-pengguna-dari-auth_usersjson)
    - [Pertimbangan Keamanan](#pertimbangan-keamanan-1)
    - [Konfigurasi](#konfigurasi-3)
    - [Pengalihan Pengguna](#pengalihan-pengguna)
    - [Diagram Mermaid](#diagram-mermaid)
        - [Diagram Urutan Alur Masuk](#diagram-urutan-alur-masuk)
        - [Diagram Logika Perute Frontend](#diagram-logika-perute-frontend)

- [Dasbor Pengguna](#dasbor-pengguna-1)
    - [Komponen Inti dan Fungsionalitas](#komponen-inti-dan-fungsionalitas-1)
        - [Struktur Frontend (user.html)](#struktur-frontend-userhtml)
        - [Fungsionalitas JavaScript (UserDashboardApp())](#fungsionalitas-javascript-userdashboardapp)
        - [Integrasi Grid Data (ag-grid-community.min.js)](#integrasi-grid-data-ag-grid-communityminjs)
        - [Penataan Gaya (output.css)](#penataan-gaya-outputcss)
    - [Alur dan Interaksi Data API](#alur-dan-interaksi-data-api)
        - [Endpoint API (Tersirat)](#endpoint-api-tersirat)
        - [Pemrosesan Data (Middleware)](#pemrosesan-data-middleware)
    - [Elemen Antarmuka Pengguna](#elemen-antarmuka-pengguna-1)
        - [Header](#header)
        - [Area Konten Utama](#area-konten-utama)
        - [Contoh Visualisasi Data (Tersirat)](#contoh-visualisasi-data-tersirat)
    - [Tinjauan Arsitektur](#tinjauan-arsitektur-2)
        - [Kerangka Kerja dan Pustaka Frontend](#kerangka-kerja-dan-pustaka-frontend)
        - [Kerangka Kerja dan Pustaka Backend](#kerangka-kerja-dan-pustaka-backend)
    - [Pertimbangan Keamanan](#pertimbangan-keamanan-2)
    - [Pengujian](#pengujian-5)

- [Dasbor Admin](#dasbor-admin-1)

- [Penyebaran Docker](#penyebaran-docker-2)
    - [Tinjauan Arsitektur](#tinjauan-arsitektur-3)
        - [Layanan](#layanan)
        - [Alur Data](#alur-data)
    - [Dockerfile dan Pembuatan Citra](#dockerfile-dan-pembuatan-citra)
        - [Instruksi Dockerfile](#instruksi-dockerfile)
    - [Konfigurasi](#konfigurasi-4)
        - [Berkas .env](#berkas-env)
        - [Direktori Konfigurasi (.config/)](#direktori-konfigurasi-config)
        - [tailwind.config.js](#tailwindconfigjs)
        - [nginx.conf](#nginxconf)
    - [Menjalankan Aplikasi dengan Docker Compose](#menjalankan-aplikasi-dengan-docker-compose)
        - [Pengembangan vs. Produksi](#pengembangan-vs-produksi)
    - [Pengujian](#pengujian-6)
    - [Metode yang Ditinggalkan](#metode-yang-ditinggalkan)
    - [Berkas .dockerignore](#berkas-dockerignore)

- [Konfigurasi Nginx](#konfigurasi-nginx-1)
    - [Konfigurasi Nginx Inti (nginx.conf)](#konfigurasi-nginx-inti-nginxconf)
        - [Blok Server](#blok-server)
        - [Penyajian Berkas Statis](#penyajian-berkas-statis)
        - [Proxy API Backend](#proxy-api-backend)
    - [Integrasi Docker (docker-compose.yml)](#integrasi-docker-docker-composeyml)
        - [Definisi Layanan Nginx](#definisi-layanan-nginx)
        - [Dependensi Layanan](#dependensi-layanan)
    - [Penyebaran dan Runtime (README.md)](#penyebaran-dan-runtime-readmemd)
    - [Perutean Frontend (front_end/router.py)](#perutean-frontend-front_endrouterpy-1)
    - [Ringkasan Peran Nginx](#ringkasan-peran-nginx)

- [Variabel Lingkungan](#variabel-lingkungan-3)
    - [Manajemen Konfigurasi](#manajemen-konfigurasi-5)
        - [Berkas .env](#berkas-env-1)
        - [APP_SECRET_KEY](#app_secret_key)
        - [API_BASE_URL](#api_base_url)
    - [Startup Sistem dan Injeksi Variabel Lingkungan](#startup-sistem-dan-injeksi-variabel-lingkungan)
        - [Penanganan Variabel Lingkungan Docker Compose](#penanganan-variabel-lingkungan-docker-compose)
    - [Ringkasan](#ringkasan-1)

- [Kustomisasi Konfigurasi](#kustomisasi-konfigurasi)
    - [Struktur Berkas Konfigurasi](#struktur-berkas-konfigurasi)
    ...
    - [Pemrosesan Data dan Pemuatan Konfigurasi](#pemrosesan-data-dan-pemuatan-konfigurasi)
        - [Direktori Konfigurasi](#direktori-konfigurasi)
        - [Memuat rekomendasi.json](#memuat-rekomendasijson)
        - [Membuat Buku Kerja Excel](#membuat-buku-kerja-excel)
    - [Konfigurasi Khusus Dasbor](#konfigurasi-khusus-dasbor)
        - [Konfigurasi Dasbor Rekomendasi](#konfigurasi-dasbor-rekomendasi)
        - [Konfigurasi Dasbor IKU](#konfigurasi-dasbor-iku)
    - [Contoh Cuplikan Konfigurasi](#contoh-cuplikan-konfigurasi)
        - [Contoh headers.json](#contoh-headersjson)
        - [Contoh rekomendasi.json](#contoh-rekomendasijson)
        - [Contoh table_structure_IKU.csv](#contoh-table_structure_ikucsv)
        - [Contoh iku_mapping.json](#contoh-iku_mappingjson)
    - [Integrasi Sistem](#integrasi-sistem)

- [Menambah dan Mengelola Pengguna](#menambah-dan-mengelola-pengguna)
    - [Otentikasi dan Otorisasi Pengguna](#otentikasi-dan-otorisasi-pengguna-1)
        - [Endpoint Masuk (/api/login)](#endpoint-masuk-apilogin-1)
        - [Endpoint Keluar (/api/logout)](#endpoint-keluar-apilogout)
        - [Rute Terlindungi](#rute-terlindungi-1)
    - [Skrip Manajemen Pengguna (add_user.py)](#skrip-manajemen-pengguna-add_userpy)
        - [Fungsionalitas](#fungsionalitas)
        - [Penggunaan](#penggunaan-1)
    - [Penyimpanan Data Pengguna (.config/auth_users.json)](#penyimpanan-data-pengguna-configauth_usersjson)
    - [Antarmuka Masuk Frontend (front_end/templates/login.html)](#antarmuka-masuk-frontend-front_endtemplatesloginhtml)
        - [Komponen](#komponen)
    - [Persyaratan Sistem untuk Manajemen Pengguna](#persyaratan-sistem-untuk-manajemen-pengguna)
    - [Menguji Manajemen Pengguna](#menguji-manajemen-pengguna)
        - [Penyiapan Pengujian](#penyiapan-pengujian)
        - [Klien Pengujian](#klien-pengujian)
    - [Diagram Mermaid](#diagram-mermaid-1)
        - [Alur Otentikasi Pengguna](#alur-otentikasi-pengguna-1)
        - [Struktur Data Pengguna](#struktur-data-pengguna)
        - [Alur Penambahan Pengguna](#alur-penambahan-pengguna)
...
## Tinjauan Mekanisme Pencadangan (Backup)
Sistem pencadangan beroperasi melalui kontainer Docker khusus yang didefinisikan sebagai `backup_id_srd_iku` dalam berkas `docker-compose.yml`.
- Sistem ini beroperasi menggunakan citra (image) Alpine Linux.
- Sistem ini mengeksekusi pekerjaan cron setiap hari pada pukul 02:00 pagi (`0 2 * * *`).
- Jadwal ini memicu skrip lokal `backup.sh`.
- Kontainer memetakan direktori basis data langsung (live database directory) dalam mode hanya baca (`ro`) untuk mencegah penimpaan yang tidak disengaja selama rutinitas pencadangan.

## Lokasi Penyimpanan
- **Berkas Basis Data Langsung (DuckDB):** `./desa_db/dbs`
- **Direktori Tujuan Pencadangan:** `./backups`

## Prosedur Pemulihan Langkah demi Langkah

DuckDB memberlakukan penguncian penulis tunggal (single-writer file lock) yang ketat. Layanan backend yang memegang koneksi aktif ke berkas basis data harus dihentikan sebelum mengganti data apa pun. Modifikasi pada berkas `.db` atau `.db.wal` yang aktif akan mengakibatkan kerusakan data.

### Menghentikan Layanan Backend
Eksekusi perintah ini dari direktori akar proyek untuk menghentikan kontainer backend dan melepaskan semua kunci basis data dengan aman.

    docker compose stop backend_id_srd_iku

### Menemukan Cadangan (Backup)
Navigasi ke folder cadangan dan identifikasi berkas `.bak` target.

    ls -la ./backups

### Mengganti Berkas Basis Data
Hapus berkas basis data langsung yang ada untuk mencegah ketidaksesuaian versi, kemudian salin berkas `.bak` ke dalam direktori basis data. Ganti nama berkas agar sesuai dengan nama basis data aktif yang diharapkan oleh sistem.

    # Hapus berkas basis data saat ini
    rm -rf ./desa_db/dbs/*

    # Salin cadangan dan masukkan ke dalam basis data
    cp ./backups/<nama_berkas_cadangan>.bak ./desa_db/dbs/<nama_basis_data>.db

### Memulai Ulang Layanan
Aktifkan kembali layanan backend untuk memuat status berkas yang telah dipulihkan.

    docker compose start backend_id_srd_iku

### Memverifikasi Log
Pantau log kontainer backend untuk mengonfirmasi bahwa basis data terpasang dengan bersih dan tidak ada kesalahan saat startup atau penguncian berkas yang terjadi.

    docker compose logs -f backend_id_srd_iku

## Manajemen Server dengan Tmux
Navigasi sisi server dan eksekusi latar belakang yang persisten melalui SSH ditangani menggunakan `tmux` (Terminal Multiplexer). Ini memastikan proses tetap aktif bahkan jika koneksi SSH terputus.

### Perintah Manajemen Sesi
Untuk melihat semua sesi tmux yang sedang aktif:

    tmux ls

Untuk terhubung ke sesi yang ada (ganti `<nama_sesi>` dengan nama target dari daftar):

    tmux attach -t <nama_sesi>

Untuk keluar dari sesi secara anggun melalui baris perintah sambil membiarkannya berjalan di latar belakang:

    tmux detach

### Cheatsheet Penting
Tmux menggunakan urutan kunci awalan (prefix key) sebelum mengeksekusi pintasan. Awalan default adalah `Ctrl+b`.

- `Ctrl+b`, lalu `d`: Keluar dari sesi saat ini.
- `Ctrl+b`, lalu `c`: Membuat jendela baru di dalam sesi.
- `Ctrl+b`, lalu `n`: Pindah ke jendela berikutnya.
- `Ctrl+b`, lalu `p`: Pindah ke jendela sebelumnya.
- `Ctrl+b`, lalu `&`: Menutup jendela saat ini.

Untuk daftar pintasan yang komprehensif dan penggunaan lanjutan, rujuk ke [Lembar Contekan Tmux (Tmux Cheat Sheet)](https://tmuxcheatsheet.com/).

### Pemulihan Inisialisasi Layanan
Jika tidak ada sesi tmux yang aktif dan Anda perlu memulai sistem secara manual, eksekusi skrip inisialisasi langsung dari terminal:

    bash start.sh

## Tinjauan Cloudflare Tunnel
Panduan ini menjelaskan cara mengekspos server web Nginx lokal (yang merutekan lalu lintas frontend dan backend pada port 80) ke internet publik secara aman menggunakan Cloudflare Tunnels, tanpa memerlukan penerusan port (port forwarding) atau alamat IP publik statis.

## Prasyarat
Instal daemon Cloudflare (`cloudflared`) pada mesin host yang menjalankan tumpukan Docker.

    # Debian/Ubuntu
    curl -L --output cloudflared.deb https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64.deb
    sudo dpkg -i cloudflared.deb

## Metode A: Terowongan Gratis Sementara (Tanpa Domain)
Metode ini menyediakan URL `trycloudflare.com` yang dibuat secara acak. URL tersebut berubah setiap kali layanan dimulai ulang. Sangat ideal untuk pengujian cepat. Direkomendasikan hanya untuk pengembangan, jangan gunakan pada Penerapan Produksi.

Mulai terowongan yang mengarah ke layanan Nginx lokal (port 8080).

    cloudflared tunnel --url http://localhost:8080

Terminal akan menampilkan URL yang dibuat secara acak (contoh: `https://random-words.trycloudflare.com`). Akses URL ini di peramban untuk melihat sistem.

## Metode B: Terowongan Permanen (Domain Kustom)
Metode ini memerlukan akun Cloudflare dengan domain aktif yang telah dikonfigurasi. Metode ini menyediakan URL yang persisten dan bermerek.

### Otentikasi
Otentikasi daemon dengan akun Cloudflare Anda. Perintah ini menghasilkan tautan; buka tautan tersebut di peramban untuk mengotorisasi domain Anda.

    cloudflared tunnel login

### Pembuatan Terowongan
Buat terowongan baru. Ganti `<tunnel-name>` dengan pengenal yang mudah dikenali (contoh: `base-system`).

    cloudflared tunnel create <tunnel-name>

Hubungkan terowongan ke subdomain spesifik di akun Cloudflare Anda. Ganti `<subdomain.yourdomain.com>` dengan URL yang diinginkan.

    cloudflared tunnel route dns <tunnel-name> <subdomain.yourdomain.com>

### Konfigurasi
Buat berkas konfigurasi untuk mendefinisikan aturan perutean.

    mkdir -p ~/.cloudflared
    nano ~/.cloudflared/config.yml

Tambahkan konfigurasi berikut. Ganti `<tunnel-UUID>` dengan ID yang dihasilkan selama langkah pembuatan, dan sesuaikan jalur kredensial jika Anda tidak berjalan sebagai root.
...
### Eksekusi
Jalankan terowongan secara manual untuk menguji koneksi.

    cloudflared tunnel run <tunnel-name>

Untuk memasangnya sebagai layanan latar belakang yang otomatis dimulai saat sistem boot:
